...
if (!empty($_POST)) {
	...
	if ($_POST['employeenumber'] != '' && $_POST['password'] != '') {
		$login = $db->prepare('SELECT * FROM members WHERE employeenumber=? AND
			password=?');
			$login->execute(array(
...
<main class="main">
		...
		<form action="" method="post">
                <table border="0" cellspacing="0" cellpadding="0">
                  ...
                  <div class="contact startfade2" id="firstBox">
                    ...
                    <dl class="form-area">
                        ...
                        <dd>
						<input type="text" class="input-text" name="employeenumber" size="35" maxlength="255"  value="<?php echo htmlspecialchars($_POST['employeenumber'], ENT_QUOTES); ?>"/>
                       ...
                       <dd>
						<input type="password" class="input-text" name="password" size="35" maxlength="255" value="<?php echo htmlspecialchars($_POST['password'], ENT_QUOTES); ?>" />
					   </dd>
                    </dl>
          ...
          <p class="confirm-text"><a href="./admin-login.php"><font color="blue">管理者はこちらへ</font></a></p>
