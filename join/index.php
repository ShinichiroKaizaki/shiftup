  ...
  <form action="" method="post" enctype="multipart/form-data">
                <table border="0" cellspacing="0" cellpadding="0">
                  ...
                  <div class="contact startfade2" id="firstBox">
                    ...
                    <dl class="form-area">
        				...
        				<dd><input class="input-text" type="text" name="employeenumber" size="35" maxlength="255" value="<?php echo htmlspecialchars($_POST['employeenumber'], ENT_QUOTES, 'UTF-8'); ?>"/>
								<?php if ($error['employeenumber'] == 'blank'): ?>
								<p class="error">* 社員番号を入力してください</p>
								<?php endif; ?>
								<?php if ($error['employeenumber'] == 'duplicate'): ?>
									<p class="error">* 申し訳ございません．指定された社員番号はすでに登録されています</p>
								<?php endif; ?>
								</dd>

                <dt><span class="required">お名前</span></dt>
        				<dd><input class="input-text" type="text" name="name" size="35" maxlength="255" value="<?php echo htmlspecialchars($_POST['name'], ENT_QUOTES, 'UTF-8'); ?>"/>
						...
						<dd>
							<input class="input-text" type="text" name="email" size="35" maxlength="255" value="<?php echo htmlspecialchars($_POST['email'], ENT_QUOTES, 'UTF-8'); ?>"/>
						...
						<dd>
						<input class="input-text" type="password" name="password" size="10" maxlength="20" value="<?php echo htmlspecialchars($_POST['password'], ENT_QUOTES, 'UTF-8'); ?>"/>
	 ...
	 <div class="footer_top_img"><img src="../img/common/footer-top.jpg" width="100%" alt=""></div>
	    <footer class="footer">
	      ...
	      <p class="copyright"><small>&copy;愛媛新聞社</small></p>
	    </footer>
	<!-- footerここまで -->
